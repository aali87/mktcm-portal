...
async function main() {
  ...
  const workbooksData = [
    ...
    },
    {
      ...
      weekNumber: 4,
      s3FolderPath: 'workbooks/optimal-fertility-blueprint/week-4-blood',
      totalPages: 8,
      bonusOnly: false,
      orderIndex: 4,
    },
    ...
    },
    {
      ...
      weekNumber: 6,
      s3FolderPath: 'workbooks/optimal-fertility-blueprint/week-6-shen',
      totalPages: 8,
      bonusOnly: false,
      orderIndex: 6,
    },
    {
      ...
      weekNumber: 7,
      s3FolderPath: 'workbooks/optimal-fertility-blueprint/week-7-kidneys',
      totalPages: 8,
      bonusOnly: false,
      orderIndex: 7,
    },
    {
      ...
      weekNumber: 8,
      s3FolderPath: 'workbooks/optimal-fertility-blueprint/week-8-heart',
      totalPages: 8,
      bonusOnly: false,
      orderIndex: 8,
    },
    {
      ...
      weekNumber: 9,
      s3FolderPath: 'workbooks/optimal-fertility-blueprint/week-9-integration',
      totalPages: 8,
      bonusOnly: false,
      orderIndex: 9,
    },
